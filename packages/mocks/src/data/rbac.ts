...
const matrix: Record<string, Matrix> = {
  OPERATOR: {
    ...
    sales_orders: E, payments: V, logistics_tasks: E, users: V, customers: E, technicians: V, reviews: V, fee_rules: V, branches: V, tickets: [...E, "assign"], loyalty: V, crm: E,
  },
  DISPATCHER: {
  ...
  SALES_EMPLOYEE: {
    ...
    b2b_accounts: M, partner_commissions: V, logistics_tasks: V, users: V, customers: E, branches: V, tickets: E, loyalty: E, crm: M,
  },
  ACCOUNTANT: {
  ...
  MANAGER: {
    ...
    reviews: M, kpi_targets: V, content: V, branches: V, tickets: M, loyalty: M, crm: M,
  },

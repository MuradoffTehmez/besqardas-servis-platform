...
const words = {
  az: {
    ...
    about: "Haqqımızda",
    contact: "Əlaqə",
    book: "Servis sifariş et",
    account: "Şəxsi kabinet",
    login: "Daxil ol",
    hero: "Evinizin rahatlığı,",
    hero2: "bizim qayğımız.",
    intro:
      "Kondisionerdən kombiyə, quraşdırmadan təmirə — texniki qayğılarınızı etibar etdiyiniz ustalara həvalə edin.",
    eyebrow: "EVİNİZ ÜÇÜN ETİBARLI SERVİS",
    all: "Bütün xidmətlər",
    search: "Xidmət və ya məhsul axtar...",
    choose: "Sizə necə kömək edə bilərik?",
    sub: "Bir ünvan. Bütün texniki həllər.",
    cart: "Səbət",
    continue: "Davam et",
    back: "Geri",
    ...
    retry: "Yenidən yoxla",
    loading: "Yüklənir...",
    demo: "Təqdimat versiyası · Sifariş və ödənişlər simulyasiyadır",
    add: "Səbətə əlavə et",
    details: "Ətraflı",
    orders: "Servis sifarişləri",
    devices: "Cihazlarım",
    dashboard: "İcmal",
    logout: "Çıxış",
    email: "E-poçt",
    ...
    loginHint: "Sifarişlərinizi, cihazlarınızı və servis tarixçənizi bir yerdən idarə edin.",
    price: "Qiymət",
    from: "başlayan",
    verified: "Yoxlanılmış usta",
    guarantee: "Zəmanətli xidmət",
    onTime: "Sizə uyğun vaxtda",
    transparent: "Şəffaf qiymətlər",
    how: "Servis sifarişi bu qədər sadədir",
    howSub: "Üç addımda qayğılarınızı bizə həvalə edin.",
    step1: "Xidməti seçin",
    step2: "Vaxtı müəyyən edin",
    step3: "Rahatlığın dadını çıxarın",
    popular: "Eviniz üçün seçdiklərimiz",
    browse: "Kataloqa bax",
    ready: "Texniki qayğıları bizə buraxın.",
    readySub: "Etibarlı servis bir neçə klik uzaqlıqdadır.",
    status: "Status",
    date: "Tarix",
    customer: "Müştəri",
    new: "Yeni sifariş",
    ...
    success: "Sifarişiniz qəbul olundu!",
    successSub: "Sifarişin gedişini şəxsi kabinetinizdən izləyə bilərsiniz.",
    viewOrders: "Sifarişlərə bax",
    serviceForm: "İcra forması",
    onsite: "Ünvanda servis",
    carry: "Servis mərkəzinə gətirmə",
    pickup: "Götürmə və çatdırma",
    time: "Uyğun tarix və vaxt",
    summary: "Sifarişin xülasəsi",
    checkout: "Sifarişi rəsmiləşdir",
    remove: "Sil",
    available: "Stokda var",
    unavailable: "Stokda yoxdur",
    allProducts: "Bütün məhsullar",
    allCategories: "Bütün kateqoriyalar",
    help: "Köməyə ehtiyacınız var?",
    working: "B.e.–Şənbə · 09:00–19:00",
    backHome: "Ana səhifəyə qayıt",
    notFound: "Bu səhifə tapılmadı",
    plan: "Abunəlik",
    profile: "Profil",
    schedule: "İş cədvəli",
    inventory: "Anbar",
    ...
    cash: "Təhvil zamanı nağd",
    consent: "Demo sifarişin yaradılmasına razıyam.",
    chooseService: "Xidmət seçimi",
    clear: "Filtrləri təmizlə",
    more: "Daha çox göstər",
    results: "nəticə",
    since: "Texniki qayğı, insani yanaşma.",
    aboutText:
      "Məqsədimiz ev və iş yerlərində texniki xidmətləri daha rahat və izlənilə bilən etməkdir. Quraşdırma, diaqnostika, təmir və periodik servisi vahid platformada birləşdiririk.",
    demoNote: "Bu saytdakı məhsullar, qiymətlər, ustalar və əlaqə məlumatları nümayiş üçündür.",
  ...
  en: {
    ...
    account: "My account",
    login: "Sign in",
    hero: "Your home’s comfort,",
    hero2: "our care.",
    intro:
      "From air conditioning to heating, installation to repair — leave your technical needs in trusted hands.",
    eyebrow: "RELIABLE CARE FOR YOUR HOME",
    all: "All services",
    search: "Search services or products...",
    choose: "How can we help you?",
    sub: "One place. Every technical solution.",
    cart: "Cart",
    continue: "Continue",
    back: "Back",
    ...
    retry: "Try again",
    loading: "Loading...",
    demo: "Demo version · Orders and payments are simulated",
    add: "Add to cart",
    details: "Details",
    ...
    loginHint: "Manage your orders, devices and service history in one place.",
    price: "Price",
    from: "from",
    verified: "Verified technician",
    guarantee: "Guaranteed service",
    onTime: "At your convenience",
    transparent: "Transparent pricing",
    how: "Booking a service is this simple",
    howSub: "Leave your worries to us in three steps.",
    step1: "Choose a service",
    step2: "Pick a time",
    step3: "Enjoy the comfort",
    popular: "Selected for your home",
    browse: "Browse catalog",
    ready: "Leave the technical worries to us.",
    readySub: "Reliable service is a few clicks away.",
    status: "Status",
    date: "Date",
    customer: "Customer",
    new: "New order",
    ...
    successSub: "Track your order in your account.",
    viewOrders: "View orders",
    serviceForm: "Service location",
    onsite: "At your address",
    carry: "Bring to service center",
    pickup: "Pickup and delivery",
    time: "Preferred date and time",
    ...
    consent: "I agree to create this demo order.",
    chooseService: "Choose a service",
    clear: "Clear filters",
    more: "Show more",
    results: "results",
    since: "Technical care. A human approach.",
    aboutText:
      "We make technical services easier to arrange and track. Installation, diagnostics, repair and maintenance come together in one platform.",
    demoNote:
      "Products, prices, technicians and contact information on this site are for demonstration.",
  ...
  ru: {
    ...
    about: "О нас",
    contact: "Контакты",
    book: "Заказать сервис",
    account: "Личный кабинет",
    login: "Войти",
    hero: "Комфорт вашего дома,",
    hero2: "наша забота.",
    intro:
      "От кондиционеров до отопления, от установки до ремонта — доверьте технические заботы проверенным мастерам.",
    eyebrow: "НАДЁЖНЫЙ СЕРВИС ДЛЯ ВАШЕГО ДОМА",
    all: "Все услуги",
    search: "Поиск услуг и товаров...",
    choose: "Чем мы можем помочь?",
    sub: "Один адрес. Все технические решения.",
    cart: "Корзина",
    continue: "Продолжить",
    back: "Назад",
    ...
    retry: "Повторить",
    loading: "Загрузка...",
    demo: "Демоверсия · Заказы и платежи имитируются",
    add: "В корзину",
    details: "Подробнее",
    orders: "Сервисные заказы",
    ...
    loginHint: "Управляйте заказами, устройствами и историей обслуживания в одном месте.",
    price: "Цена",
    from: "от",
    verified: "Проверенный мастер",
    guarantee: "Сервис с гарантией",
    onTime: "В удобное время",
    transparent: "Прозрачные цены",
    how: "Заказать сервис просто",
    howSub: "Передайте нам заботы за три шага.",
    step1: "Выберите услугу",
    step2: "Укажите время",
    step3: "Наслаждайтесь комфортом",
    popular: "Выбрано для вашего дома",
    browse: "Открыть каталог",
    ready: "Оставьте технические заботы нам.",
    readySub: "Надёжный сервис в нескольких кликах.",
    status: "Статус",
    date: "Дата",
    customer: "Клиент",
    new: "Новый заказ",
    ...
    successSub: "Следите за заказом в личном кабинете.",
    viewOrders: "Мои заказы",
    serviceForm: "Формат обслуживания",
    onsite: "На вашем адресе",
    carry: "Привезти в сервис",
    pickup: "Забор и доставка",
    ...
    review: "Открыть заказ",
    payment: "Способ оплаты",
    cash: "Наличными при получении",
    consent: "Я согласен создать демонстрационный заказ.",
    chooseService: "Выбор услуги",
    clear: "Сбросить фильтры",
    more: "Показать ещё",
    results: "результатов",
    since: "Техническая забота. Человеческий подход.",
    aboutText:
      "Мы делаем техническое обслуживание удобным и прозрачным. Установка, диагностика, ремонт и обслуживание объединены на одной платформе.",
    demoNote: "Товары, цены, мастера и контактные данные представлены для демонстрации.",
    faq: "Частые вопросы",
  },
};

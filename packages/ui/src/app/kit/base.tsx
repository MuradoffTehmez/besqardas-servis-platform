...
const TONE_BY_CODE: [RegExp, string][] = [
  [/(CANCEL|REJECT|FAIL|EXPIRED|BLOCK|VOID|DOWN|DISCREPANCY|OUT_OF_STOCK|REVOKED|DISPUTED|PAST_DUE|BREACHED)/, "danger"],
  [/(WAIT|PENDING|HOLD|DRAFT|LOW|GRACE|EXPIRING|REQUESTED|UNDER_REVIEW|DEGRADED|PARTIAL|RETURN_REQUESTED|PENDING_PAYMENT|INVITED|ON_THE_WAY|ARRIVED|IN_TRANSIT|AT_RISK)/, "warning"],
  [/(COMPLETED|CLOSED|PAID|ACTIVE|APPROVED|VERIFIED|DELIVERED|IN_STOCK|PUBLISHED|RECEIVED|DONE|OK|ACCEPTED|CONFIRMED|CONVERTED|REFUNDED|ISSUED|ACKNOWLEDGED|RESOLVED|ON_TRACK|^MET$)/, "success"],
  [/(NEW|READY|ASSIGNED|IN_PROGRESS|PROCESSING|SENT|SHIPPED|PLANNED|TRIAL|PICKED_UP|INITIATED|^OPEN$)/, "info"],
];
